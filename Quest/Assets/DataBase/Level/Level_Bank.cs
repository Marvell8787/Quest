...
static class Level_Bank
{
    ...
    public static string[] Level_QuestionType = new string[5] { "字彙聽力題", "聽力單選題", "字彙單選題", "句型單選題", "閱讀理解題" };
    public static string[] Level_Range = new string[5] { "字彙1-8", "字彙1-8、句型", "字彙1-8", "字彙1-8、句型", "字彙1-8、句型" };
    //獎
