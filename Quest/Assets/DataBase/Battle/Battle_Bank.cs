...
static class Battle_Bank{
    ...
    public static string[] Battle_Range = new string[2] { "字彙1-8、3個母音", "字彙1-8、句型、日常用語"};
    ...
    //獎
    public static string[] Battle_Reward_0 = new string[2] { "水晶 +50", "水晶 +200" };
    public static string[] Battle_Reward_1 = new string[2] { "無", "無" };
    //懲
    public static string[] Battle_Punishment_0 = new string[2] { "水晶 -50、戰鬥點數 -1、失誤 +1", "水晶 -200、戰鬥點數 -1、失誤 +1" };
