...
static class Task_Bank
{
    ...
    public static string[] Battle_Reward_O = new string[2] { "分數 +30", "分數 +50" };
    public static string[] Battle_Punishment_O = new string[2] { "分數 -30、任務點數 -1、失誤 +1", "分數 -50、任務點數 -1、失誤 +1" };
    public static string[] Battle_Reward_X = new string[2] { "無", "無" };
    public static string[] Battle_Punishment_X = new string[2] { "無", "無" };
    //獎懲數字
    public static int[] Task_Reward = new int[7] {  30, 50, 30, 50, 100, 30, 50 };
    public static int[] Task_Punishment = new int[7] {  -30, -50, -30, -50, -100, -30, -50 };
    //狀態
