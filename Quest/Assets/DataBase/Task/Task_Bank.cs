...
static class Task_Bank
{
    ...
    public static string[] Learn_Reward_O = new string[5] { "分數 +10", "分數 +30", "分數 +10", "分數 +30", "分數 +50" };
    public static string[] Learn_Punishment_O = new string[5] { "分數 -10", "分數 -30", "分數 -10","分數 -30", "分數 -50" };
    ...
    public static string[] Battle_Reward_O = new string[2] { "分數 +10", "分數 +50" };
    public static string[] Battle_Punishment_O = new string[2] { "分數 -10", "分數 -50" };
