...
public class UI_Guide : MonoBehaviour {
    ...
    void Item2()
    {
        ...
        {
            case 0:
                Info_text.text = "1.卡牌共22張，可至商店獲得，分成三類，分別是前衛、中鋒及支援，前衛卡為攻擊力高但沒有效果的卡；中鋒卡為攻擊力低，但有能與前鋒卡的攻擊力做相加的效果；支援卡為沒有攻擊力，但有能恢復玩家在戰鬥中的生命值的效果。\n\n"
            ...
            case 1:
                ...
                break;
            case 2:
                Info_text.text = "1.卡牌分成三類，分別是前衛、中鋒及支援，前衛卡為攻擊力高但沒有效果的卡；中鋒卡為攻擊力低，但有能與前鋒卡的攻擊力做相加的效果；支援卡為沒有攻擊力，但有能恢復玩家在戰鬥中的生命值的效果。\n\n";
                Info2_text.text = "1.點數分三類，分為任務、學習及戰鬥，每當有任務、學習或失敗發生時，則會扣除任務、學習或戰鬥點數，當點數扣至0，則會使分數、學習或水晶減半(先懲罰再減半)。\n\n";
                Info3_text.text = "2.失誤分三類，分為警告、黃牌及紅牌，每當有失敗發生時，就會增加一支警告，每三支警告換成一張黃牌，每三張黃牌換成一張紅牌，每拿到一張紅牌時，失敗的懲罰會加倍。";
    ...
    void Task()
    {
        Image_obj.SetActive(false);
        PageTurnning.Play();
        Info_text.text = "1.任務一共有七項，分別為五項學習任務及兩項戰鬥任務，每項任務僅能進行兩次。\n\n"
