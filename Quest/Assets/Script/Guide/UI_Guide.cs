    ...
    void Item2()
    {
        ...
        switch (System_Data.Version)
        {
            case 0:
                ...
                Info2_text.text = "1.點數分三類，分為任務、學習及戰鬥，每當有任務、學習或失敗發生時，則會扣除任務、學習或戰鬥點數，當點數扣至0或0以下，則會使分數、學習或水晶減半。\n\n";
            ...
            case 1:
                ...
                break;
            case 2:
                Info_text.text = "1.點數分三類，分為任務、學習及戰鬥，每當有任務、學習或失敗發生時，則會扣除任務、學習或戰鬥點數，當點數扣至0或0以下，則會使分數、學習或水晶減半。\n\n"
